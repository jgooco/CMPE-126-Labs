...
A tree is a data structure very similar to a doubly linked list, but instead of linking back and forth, the node pointers point to nodes one layer deeper. 
...
Every function than can be implemented with recursion, needs to be implemented with it. 
